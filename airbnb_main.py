...
icon = Image.open("airbnb.jpeg")
st.set_page_config(page_title="Airbnb Analysis | By NETHRA R",
                   page_icon=icon,
                   layout='wide')

# Creating Option Menu
selected  = option_menu(menu_title=None,options=["Home","Overview","Explore"],
...
client = pymongo.MongoClient("mongodb+srv://root:Test1234@cluster0.itgeida.mongodb.net/")
